...
$$
Q_\theta(s_t,a_t)=\theta^\top\phi(s_t,a_t),
$$

and

$$
Q_\theta(s_{t+1},a_{t+1})=\theta^\top\phi(s_{t+1},a_{t+1}).
$$
...
r_t
+
\gamma\theta^\top\phi(s_{t+1},a_{t+1})
-
\theta^\top\phi(s_t,a_t).
$$
...
\mathcal F
=
\{Q_\theta:Q_\theta(s,a)=\theta^\top\phi(s,a)\}.
$$
...
r_t
+
\gamma\max_{a'}\theta^\top\phi(s_{t+1},a')
-
\theta^\top\phi(s_t,a_t).
$$
