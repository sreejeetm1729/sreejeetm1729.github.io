...
<ul>
  ...
  <li style="font-size:15px">
    <em><strong>March 2026</strong></em>: Invited talk
    "<strong>Towards a Finite-Time Theory for Adversarially-Robust Reinforcement Learning</strong>"
    delivered at the CORAL Seminar, ECE Department, NCSU.
  </li>

  <li style="font-size:15px">
    <em><strong>January 2026</strong></em>: Our works titled
  ...
  <li style="font-size:15px">
    <em><strong>October 2025</strong></em>: Presented a poster titled
    "<strong>Robust Federated Reinforcement Learning with Byzantine Agents</strong>"
    at the Applied AI Symposium 2025.
  </li>
  ...
  <li style="font-size:15px">
    <em><strong>September 2024</strong></em>: Presented a poster titled
    "<strong>Robust Algorithms for Adversarial Reinforcement Learning</strong>"
    at the Applied AI Symposium, Theoretical Machine Learning Track.
  </li>
  ...
  <li style="font-size:15px">
    <em><strong>September 2024</strong></em>: Received the
    "<strong>IEEE CDC 2024 Student Travel Support Award</strong>".
  </li>
  ...
  <li style="font-size:15px">
    <em><strong>July 2023</strong></em>: Graduated from the Indian Institute of Science, Bangalore, with an M.Tech. in Robotics and Autonomous Systems.
  </li>

  <li style="font-size:15px">
    <em><strong>February--March 2023</strong></em>: Received Ph.D. offers from North Carolina State University and Purdue University.
  </li>
</ul>
