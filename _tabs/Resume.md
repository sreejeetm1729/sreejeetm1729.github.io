...
.cv-section {
  margin-top: 2.1rem;
  padding-top: 1.1rem;
  border-top: 3px solid rgba(216,167,167,0.55);
}
...
<div style="margin-top:2rem; padding:1rem 1.2rem; border:1px solid rgba(165,243,252,0.28); border-radius:14px; background:rgba(165,243,252,0.04); font-size:16px; line-height:1.7; text-align:justify;">
  ...
  I am always happy to engage with researchers working on broad areas of reinforcement learning, control theory, federated learning, and trustworthy machine learning. If you are interested in discussing possible collaborations or exchanging research ideas, please reach out to me via
...
<h2>Workshop Presentations and Invited Talks</h2>
...
<ul class="cv-list">
  ...
  <li><span class="cv-highlight">Towards Finite-Time Rates for Adversarially-Robust RL</span>, CORAL Seminar, NCSU.</li>
</ul>
...
<div class="cv-entry">
  <div class="cv-entry-title">Federated MARL-GYM <a href="https://github.com/sreejeetm1729/Federated-MARL-Gym-Environment" target="_blank">
...
<ul class="cv-list">
  <li><span class="cv-highlight">ACC 2026 Travel Award</span> <span class="cv-award-date">May 2026</span></li>
  <li><span class="cv-highlight">L4DC Student Support Grant</span> <span class="cv-award-date">May 2025</span></li>
